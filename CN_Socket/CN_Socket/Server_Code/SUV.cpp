    ...
    if (fin.is_open() && fout.is_open()) {
        ...
        while (fin >> car_id) {
            ...
            if (car_id == id) {
                ...
                cout << "Enter new Offroad Capability: "; while (!(cin >> offroad_capability)) { cout << "Invalid input. Enter offroad capability: "; cin.clear(); cin.ignore(numeric_limits<streamsize>::max(), '\n'); }
                cout << "Enter new Towing Capacity: "; while (!(cin >> towing_capacity)) { cout << "Invalid input. Enter towing capacity: "; cin.clear(); cin.ignore(numeric_limits<streamsize>::max(), '\n'); }
            }
        ...
        if (!found) cout << "SUV with ID " << id << " not found." << endl;
        else cout << "SUV updated successfully." << endl;
    }
    else {
