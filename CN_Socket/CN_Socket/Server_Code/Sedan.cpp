    ...
    if (fin.is_open() && fout.is_open()) {
        ...
        while (fin >> car_id) {
            ...
            if (car_id == id) {
                ...
                cout << "Enter new Trunk Capacity: "; while (!(cin >> trunk_capacity)) { cout << "Invalid input. Enter trunk capacity: "; cin.clear(); cin.ignore(numeric_limits<streamsize>::max(), '\n'); }
                cout << "Enter new Fuel Efficiency: "; while (!(cin >> fuel_efficiency)) { cout << "Invalid input. Enter fuel efficiency: "; cin.clear(); cin.ignore(numeric_limits<streamsize>::max(), '\n'); }
            }
        ...
        if (!found) cout << "Sedan with ID " << id << " not found." << endl;
        else cout << "Sedan updated successfully." << endl;
    }
    else {
